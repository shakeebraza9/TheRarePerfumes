...
Route::post('/check-stock', [App\Http\Controllers\CartController::class, 'checkStock']);
...
Route::middleware(['web', 'auth'])->group(function () {
  ...
  Route::get('admin/orders/delete/{id}', [App\Http\Controllers\Admin\OrderController::class, 'delete']);
