                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input   type="text" value="{{$model->link}}" name="link" class="form-control" 
                                placeholder="Link">
                                @if($errors->has('link'))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$model->button}}" name="button" class="form-control" 
                                placeholder="button">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"   value="{{$model->sort}}" name="sort" class="form-control" placeholder="Sort"> 
                                @if($errors->has('sort'))
