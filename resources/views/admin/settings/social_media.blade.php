...
<link href="{{asset('public/admin/assets/summernote/summernote-bs4.css')}}" rel="stylesheet">
<style>
    .error{
        color:red;
    }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                                <label>Instagram Link</label>
                                <input type="text" value="{{ $data['social_media']['tiktok_link'] ?? '' }}" class="form-control" placeholder="Tiktok link" name="tiktok_link[value]">
                                <input type="hidden" name="tiktok_link[type]" value="text">
                            </div>
                        </div>  
...
<script src="{{asset('public/admin/assets/summernote/summernote-bs4.min.js')}}"></script>
<script>
