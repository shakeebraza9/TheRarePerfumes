                                    ...
                                    <table class="bg-white table table-bordered table-hover text-center">
                                        ...
                                        <tfoot class="font-weight-600">
                                            ...
                                            <tr id="cc_row" style="display:none;">
                                                <td colspan="3" class="text-end">Credit Card Charges (10%)</td>
                                                <td id="cc_amount"></td>
                                            </tr>
                                            <tr>
...
@section('js')
    ...
    <script>
    const baseTotal = parseFloat("{{ $cart['grand_total'] }}");
    ...
    document.getElementById('payment_method').addEventListener('change', function () {
        ...
        if (this.value == 4) {
            let cc = (baseTotal * 10) / 100;
            total = baseTotal + cc;

            document.getElementById('cc_row').style.display = '';
            document.getElementById('cc_amount').innerText = currency + ' ' + cc.toFixed(2);
        } else {
            document.getElementById('cc_row').style.display = 'none';
        }

        document.getElementById('grand_total').innerText = currency + ' ' + total.toFixed(2);
    });
</script>
