...
<div id="page-content">
        ...
        <div class="section">
         <div class="hero hero--medium hero__overlay bg-size background-parallax" 
     style="background-image: url('{{ asset($_s['home_page_banner']) }}'); background-size: cover; background-position: 50% 31px; background-repeat: no-repeat;">
    ...
    <a href="{{URL::to('/shop')}}" class="btn border-btn-1 btn--large d-inline-block px-4">Shop Now</a>
</div>
