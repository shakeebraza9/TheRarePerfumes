        ...
        <div class="product-rows section">
            <div class="container-fluid">
                            ...
                            @foreach ($collectionProducts->where('id', $ProductCollection->product_id) as $product)
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="grid-view-item style2 item">
                                        <div class="grid-view_image position-relative">
                                            {{-- Discount Badge --}}
                                            @if($discountPercent > 0)
                                                <div style="position:absolute;top:10px;left:10px;background:#ff0000;color:#fff;padding:5px 10px;border-radius:4px;font-size:13px;z-index:2;">
                                                    -{{ $discountPercent }}% OFF
                                                </div>
                                            @endif
                ...
                <div class="text-center">
                    <a href="/shop?collection={{ $collection->slug }}" class="btn btn-primary d-inline-block px-4">See All</a>
                </div>
