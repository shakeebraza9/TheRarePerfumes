<div class="row align-items-center">
    ...
    <div class="logo col-4 col-sm-4 col-md-2 col-lg-2 d-flex justify-content-center align-self-center">
        <button type="button" class="d-md-none btn--link site-header__menu js-mobile-nav-toggle mobile-nav--open" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Menu">
            <i class="icon an an-times"></i>
            <i class="icon an an-bars"></i>
        </button>
        <a class="d-md-none d-lg-inline" href="{{URL::to('/')}}">
            <img class="logo-web" src="{{asset($_s['logo'])}}" style="width: 50px;"/>
        </a>
    </div>

    <!--<div class="col-md-8 d-md-block d-lg-none text-center">-->
    <!--    <a href="{{URL::to('/')}}">-->
